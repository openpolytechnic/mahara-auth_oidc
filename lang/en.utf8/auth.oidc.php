...
$string['login_description'] = 'To login please click on button below.';
$string['login'] = 'Login';
...
$string['errorauthnousername'] = 'Missing username(student number) from the claims.';
...
$string['errorauthnstudentdataurl'] = 'Student data endpoint is missing.';
...
$string['settings_logoutendpoint'] = 'Logout Endpoint';
$string['settings_logoutendpoint_default'] = 'https://login.microsoftonline.com/common/oauth2/logout';
...
$string['settings_upnkey'] = 'Mahara username from claims';
$string['settings_upnkey_default'] = '[upn]';
$string['settings_studentdataurl'] = 'Student data url';
